(defproject reptile-care "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot reptile-care.core
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "reptile-care.core/mount-components"}
                     :compiler
                     {:main "reptile-care.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
